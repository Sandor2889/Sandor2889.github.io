...
<p>
<div class=pull-left>
https://user-images.githubusercontent.com/97664446/173226289-de22fd63-076f-4e20-ba16-d6a0627fd751.PNG
</div>
운영체제의 구조는 아래와 같이 이루어진다. <br>
`유저 프로그램 - GUI - 시스템 콜 - 커널 - 드라이버 - 하드웨어` <br>
운영체제는 `GUI - 시스템 콜 - 커널 - 드라이버` 부분을 지칭한다. <br>
